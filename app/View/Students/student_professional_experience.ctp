...
<script type="text/javascript">
	...
	<blockquote style="border-top-width: 0px;padding-top: 0px;padding-bottom: 0px;margin-top: 10px;margin-bottom: 5px;">
        <p style="color: #588BAD">Ingrese cada una de sus experiencias profesionales.</p>
    </blockquote>
	...
	<div class="col-md-12">	
		...
		<?php foreach($experiencias as $k => $experiencia):?>
			<div class="col-md-6" style="margin-top: 10px; border-left: 6px solid #1a75bb; background-color: #f8f8f8;">
				<?= $experiencia['StudentProfessionalExperience']['company_name']; ?>
			</div>
			<div class="col-md-6" style="margin-top: 3px;">
							
				<?php echo $this->Html->link('<i class="glyphicon glyphicon-pencil"></i>&nbsp; Editar', 
						['controller'=>'Students',
						'action'=>'editStudentProfessionalExperience',$experiencia['StudentProfessionalExperience']['id']],
						['class' => 'btn btn-primary btn-sm',
						'escape' => false]); ?>
				<?= $this->Html->link('<i class="glyphicon glyphicon-trash"></i>&nbsp; Eliminar', '#',[
										'onclick' =>"return confirma('Experiencia".$experiencia['StudentProfessionalExperience']['id']."');",
										'class' => 'btn btn-danger btn-sm',
										'escape'=> false]); ?>
				<div style="display: none">
				<?= $this->Form->postLink('Eliminar',							
						['controller'=>'Students',
						'action'=>'deleteStudentProfessionalExperience',$experiencia['StudentProfessionalExperience']['id']],
						['id'=>'eliminarExperiencia'.$experiencia['StudentProfessionalExperience']['id']]	
				); 	?>
				</div>
				<?= $this->Html->link('<i class="glyphicon glyphicon-th-list"></i>&nbsp; Puestos', '#',[
										'data-toggle'=>'collapse',
										'data-target'=>'#demo'.$experiencia['StudentProfessionalExperience']['id'],
										'class' => 'btn btn-info btn-sm',
										'escape'=> false]); ?>
			</div>

			<?php echo $this->Form->postLink(''); ?>	
			<div id="demo<?php echo $experiencia['StudentProfessionalExperience']['id']; ?>" class="collapse">
			...
			<?php foreach($experiencia['StudentWorkArea'] as $k => $puesto): ?>
			      	...
			      	<div class="col-md-6" style="margin-top: 10px; border-left: 6px solid #f2933f; ">
	...
	<div class="col-md-12" style="margin-top: 30px;">	
		<?= $this->Form->create('Student', [
									...
									'action' => 'StudentProfessionalExperience',
		...
		<fieldset>
			...
			<div class="col-md-6">	
				...
				<?= $this->Form->input('StudentWorkArea.experience_area', ['type'=>'select','options' => $Paises,'id' => 'StudentInterestJobInterestAreaId','class' => 'selectpicker show-tick form-control show-menu-arrow','data-live-search' => "true",'default'=>'0', 'empty' => 'Área de experiencia']); ?>
