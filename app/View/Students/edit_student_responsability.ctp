	...
	<ol class="breadcrumb">
	    <li><?= $this->Html->link($this->request->data['StudentWorkArea']['job_name'], ['controller'=>'Students','action' => 'editStudentWorkArea',$this->request->data['StudentWorkArea']['id']] );?></li>
	 	<li class="active"><?= 'Editando responsabilidad...'; ?></li>
	</ol>
	...
	<div class="col-md-8 col-md-offset-2" style="margin-top: 30px;">
		<?= $this->Form->create('Student', [
							...
							'action' => 'editStudentResponsability']); ?>
	
		<fieldset>	

			<?= $this->Form->input('StudentResponsability.id'); ?>

			<?= $this->Form->input('StudentResponsability.student_work_area_id',['type' =>'hidden']); ?>
