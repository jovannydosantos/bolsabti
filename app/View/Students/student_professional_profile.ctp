...
<script>
	$(document).ready(function() {
		...
		$("select#StudentProfessionalProfileMobilityStartDateYear").val('');
		$("select#StudentProfessionalProfileMobilityStartDateMonth").val('');
		$("select#StudentProfessionalProfileMobilityStartDateDay").val('');
		//End date prepend options
		...
		$("select#StudentProfessionalProfileMobilityEndDateYear").val('');
		$("select#StudentProfessionalProfileMobilityEndDateMonth").val('');
		$("select#StudentProfessionalProfileMobilityEndDateDay").val('');
	...
	<?php if($this->Session->read('tipoProfessionalProfile') == 1): ?>
		...
		<blockquote style="border-top-width: 0px; padding-top: 0px; padding-bottom: 0px;margin-top: 15px;">
	        <p style="color: #588BAD">Ingrese los datos solicitados para agregar una licenciatura.</p>
	    </blockquote>

		<div class="col-md-12">
			<?= $this->Form->postLink(''); ?>
				<?php foreach($licenciaturas as $k => $licenciatura): ?>	
					<div class="col-md-6" style="margin-top: 10px; border-left: 6px solid #1a75bb; background-color: #f8f8f8;">
						<?php 
							if($licenciatura['StudentProfessionalProfile']['unam_student']=='n'):
								echo $licenciatura['StudentProfessionalProfile']['another_career']; 
							else:
								echo $licenciatura['Career']['career']; 
							endif;
						?>
					</div>
					<div class="col-md-6" style="margin-top: 3px;">
						<?php echo $this->Html->link('<i class="glyphicon glyphicon-pencil"></i>', 
										['controller'=>'Students',
										'action'=>'editStudentProfessionalProfile',$licenciatura['StudentProfessionalProfile']['id']],
										['class' => 'btn btn-primary btn-sm',
										'escape' => false]);?>
     					<?= $this->Html->link('<i class="glyphicon glyphicon-trash"></i>', '#',[
										'onclick' =>"return confirma('".$licenciatura['StudentProfessionalProfile']['id']."');",
										'class' => 'btn btn-danger btn-sm',
										'escape'=> false]);?>
						<div style="display: none">
						<?= $this->Form->postLink('Eliminar',							
										['controller'=>'Students',
										'action'=>'deleteStudentProfessionalProfile',$licenciatura['StudentProfessionalProfile']['id']],
										['id'=>'eliminar'.$licenciatura['StudentProfessionalProfile']['id']]);?>
						</div>
					</div>
				<?php endforeach; ?>	
		</div>
	...
	<?php if($this->Session->read('tipoProfessionalProfile') == 2): ?>

		<blockquote style="border-top-width: 0px; padding-top: 0px; padding-bottom: 0px;margin-top: 15px;">
	        <p style="color: #588BAD">Ingrese los datos solicitados para agregar una especialidad.</p>
	    </blockquote>
		...
		<div class="col-md-12">
			...
			<div class="col-md-6" style="margin-top: 10px; border-left: 6px solid #1a75bb; background-color: #f8f8f8;">
				<?php 
					if($especialidad['StudentProfessionalProfile']['unam_student']=='n'):
						echo $especialidad['StudentProfessionalProfile']['another_career']; 
					else:
						echo $especialidad['PosgradoProgram']['posgrado_program']; 
					endif;
				?>
			</div>
			<div class="col-md-6" style="margin-top: 3px;">
				<?= $this->Html->link('<i class="glyphicon glyphicon-pencil"></i>', 
									  	['controller'=>'Students',
										'action'=>'editStudentProfessionalProfile',$especialidad['StudentProfessionalProfile']['id']],
										['class' => 'btn btn-primary btn-sm',
										'escape' => false]
				);?>
				<?= $this->Html->link('<i class="glyphicon glyphicon-trash"></i>', '#',[
										'onclick' =>"return confirma('".$especialidad['StudentProfessionalProfile']['id']."');",
										'class' => 'btn btn-danger btn-sm',
										'escape'=> false]);?>
				<div style="display: none">
				<?=$this->Form->postLink('Eliminar',							
										['controller'=>'Students',
										'action'=>'deleteStudentProfessionalProfile',$especialidad['StudentProfessionalProfile']['id']],
										['id'=>'eliminar'.$especialidad['StudentProfessionalProfile']['id']]);?>
				</div>
			</div>
			<?php endforeach; ?>	
		</div>
	...
	<?php if($this->Session->read('tipoProfessionalProfile') == 3): ?>

		<blockquote style="border-top-width: 0px; padding-top: 0px; padding-bottom: 0px;margin-top: 15px;">
	        <p style="color: #588BAD">Ingrese los datos solicitados para agregar una maestría.</p>
	    </blockquote>	

		<div class="col-md-12">
			<?= $this->Form->postLink(''); ?>
			<?php foreach($maestrias as $k => $maestria): ?>	
				<div class="col-md-6" style="margin-top: 10px; border-left: 6px solid #1a75bb; background-color: #f8f8f8;">
					<?php 
						if($maestria['StudentProfessionalProfile']['unam_student']=='n'):
							echo $maestria['StudentProfessionalProfile']['another_career']; 
						else:
							echo $maestria['PosgradoProgram']['posgrado_program']; 
						endif;
					?>
				</div>
				<div class="col-md-6" style="margin-top: 3px;">
					<?= $this->Html->link('<i class="glyphicon glyphicon-pencil"></i>', 
										['controller'=>'Students',
										'action'=>'editStudentProfessionalProfile',$maestria['StudentProfessionalProfile']['id']],
										['class' => 'btn btn-primary btn-sm',
										'escape' => false]); ?>
					<?= $this->Html->link('<i class="glyphicon glyphicon-trash"></i>', '#',[
										'onclick' =>"return confirma('".$maestria['StudentProfessionalProfile']['id']."');",
										'class' => 'btn btn-danger btn-sm',
										'escape'=> false]);?>
					<div style="display: none">
					<?= $this->Form->postLink('Eliminar',							
										['controller'=>'Students',
										'action'=>'deleteStudentProfessionalProfile',$maestria['StudentProfessionalProfile']['id']],
										['id'=>'eliminar'.$especialidad['StudentProfessionalProfile']['id']]); ?>
					</div>
				</div>
			<?php endforeach; ?>
	...
	<?php if($this->Session->read('tipoProfessionalProfile') == 4): ?>

		<blockquote style="border-top-width: 0px; padding-top: 0px; padding-bottom: 0px;margin-top: 15px;">
	        <p style="color: #588BAD">Ingrese los datos solicitados para agregar un doctorado.</p>
	    </blockquote>	

		<div class="col-md-12">
			<?= $this->Form->postLink(''); ?>
			<?php foreach($doctorados as $k => $doctorado): ?>	
				<div class="col-md-6" style="margin-top: 10px; border-left: 6px solid #1a75bb; background-color: #f8f8f8;">
					<?php 
						if($doctorado['StudentProfessionalProfile']['unam_student']=='n'):
							echo $doctorado['StudentProfessionalProfile']['another_career']; 
						else:
							echo $doctorado['PosgradoProgram']['posgrado_program']; 
						endif;
					?>
				</div>
				<div class="col-md-6" style="margin-top: 3px;">
					<?= $this->Html->link('<i class="glyphicon glyphicon-pencil"></i>', 
										['controller'=>'Students',
										'action'=>'editStudentProfessionalProfile',$doctorado['StudentProfessionalProfile']['id']],
										['class' => 'btn btn-primary btn-sm',
										'escape' => false]
					); 	?>
					<?= $this->Html->link('<i class="glyphicon glyphicon-trash"></i>', '#',[
										'onclick' =>"return confirma('".$doctorado['StudentProfessionalProfile']['id']."');",
										'class' => 'btn btn-danger btn-sm',
										'escape'=> false]);?>
					<div style="display: none">
					<?= $this->Form->postLink('Eliminar',							
										['controller'=>'Students',
										'action'=>'deleteStudentProfessionalProfile',$doctorado['StudentProfessionalProfile']['id']],
										['id'=>'eliminar'.$especialidad['StudentProfessionalProfile']['id']]);?>
					</div>
				</div>
			<?php endforeach; ?>
	...
	<div class="col-md-12" style="margin-top: 30px;">	
		<?= $this->Form->create('Student', [
								...
								'action' => 'StudentProfessionalProfile',
				...
				<div id="bloque1" style="display:none">	
					<?php if(($this->Session->read('tipoProfessionalProfile') == 1)): ?>
						...
						<div id="divEscuelaId">
							...
							<?= $this->Form->input('StudentProfessionalProfile.undergraduate_institution', ['type'=>'select','options' => $Escuelas,'class' => 'selectpicker show-tick form-control show-menu-arrow','default'=>'0', 'empty' => 'Escuela / Facultad']); ?>
						</div>
					...
					<?php else: ?> 
						...
						<div id="divFacultadId">
							<div class="asterisk">*</div>
							<?= $this->Form->input('StudentProfessionalProfile.undergraduate_institution', ['type'=>'select','options' => $Facultades,'class' => 'selectpicker show-tick form-control show-menu-arrow','default'=>'0', 'empty' => 'Escuela / Facultad']); ?>
						</div>
