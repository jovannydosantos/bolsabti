<?php
	...
	$objPHPExcel->getProperties()->setCreator("Sistema de Bolsa Universitaria de Trabajo UNAM")
								 ...
								 ->setKeywords("Busqueda especifica")
								 ->setCategory("Busqueda especifica");
	...
	// endif;
		$objPHPExcel->setActiveSheetIndex(0)->setCellValue('A2','Descarga de currículums / Busqueda especifica');
	...
	$objPHPExcel->getActiveSheet()->setTitle('Busqueda especifica');
	$objPHPExcel->setActiveSheetIndex(0);
	
	header('Content-Type: application/vnd.openxmlformats-officedocument.spreadsheetml.sheet');
	header('Content-Disposition: attachment;filename="Busqueda especifica.xlsx"');
