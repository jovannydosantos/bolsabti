				...
				<?php 
					...
					<fieldset>
						...
						<div class="col-md-1" style="padding-left: 0px; padding-right: 0px;">
							...
							echo $this->Form->end(); 
							?>
							<img data-toggle="tooltip" id="" data-placement="top" title="El sistema realiza búsquedas escribiendo alguna(s) palabra(s) clave(s) en el campo abierto. Ejemplos:  328265790,Juan, Pérez, j.perez@mail.com" class="img-circle cambia" alt="help.png" src="/unam/img/help.png" style="margin-left: 220%; margin-top: -90%;">
						</div>
					</fieldset>
	</div>
