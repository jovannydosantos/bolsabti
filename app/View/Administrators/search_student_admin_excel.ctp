<?php
	...
	$objPHPExcel->getProperties()->setCreator("Sistema de Bolsa Universitaria de Trabajo bti")
								 ...
								 ->setTitle("Universitarios")
								 ->setSubject("Universitarios")
								 ->setDescription("Universitarios")
								 ->setKeywords("Universitarios")
								 ->setCategory("Universitarios");
	...
	if(!isset($tipoDescarga)):
		$tipoDescarga = 'Todos los universitarios';
	endif;
	...
	$objPHPExcel->getActiveSheet()->setTitle('Universitarios');
	$objPHPExcel->setActiveSheetIndex(0);
	
	header('Content-Type: application/vnd.openxmlformats-officedocument.spreadsheetml.sheet');
	header('Content-Disposition: attachment;filename="Universitarios.xlsx"');
