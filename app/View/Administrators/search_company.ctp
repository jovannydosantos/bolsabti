<?php 
	...
	<script>
		...
		function typeSearch(){
			...
			if(selectedIndexTypeSearch==1){
				$("#AdministratorBuscar").attr("placeholder", "RFC");
			}
			else
				if(selectedIndexTypeSearch==2){
					$("#AdministratorBuscar").attr("placeholder", "Nombre de la empresa o institución");
				}
				else
					if(selectedIndexTypeSearch==3){
						$("#AdministratorBuscar").attr("placeholder", "Razón social");
					}
					else
						if(selectedIndexTypeSearch==4){
							$("#AdministratorBuscar").attr("placeholder", "Nombre del contacto");
						}
						else
							if(selectedIndexTypeSearch==5){
								$("#AdministratorBuscar").attr("placeholder", "Correo del contacto de la empresa");
							}	
							else{
	...
	<div class="col-md-12" style="margin-bottom: 10px; margin-top: 15px;">
		<p>El sistema buscará por el siguiente criterio: RFC, nombre de la empresa o institución o razón social.</p>
	</div>
				...
				<?php 
					...
					<fieldset>
						...
						<div class="col-md-1" style="padding-left: 0px; padding-right: 0px;">
							...
							echo $this->Form->end(); 
							?>
							<img data-toggle="tooltip" id="" data-placement="top" title="El sistema realiza búsquedas escribiendo alguna(s) palabra(s) clave(s) en el campo abierto. Ejemplos: GODM921208MDFMRR06, HSBC, HSBC México S.A. de C.V." class="img-circle cambia" alt="help.png" src="/unam/img/help.png" style="margin-left: 220%; margin-top: -50px;">
						</div>
					</fieldset>
	</div>
						...
						<?php 
							echo $this->Html->link(
													'Pendientes ('. $pendientes .')', 
														...
														array(
															'class' => 'btn btn-default btnBlue ',
															'style' => 'margin-top: 5px; width: 150px;'. $seleccionado20 ,
															)	
						); 	?> 
					</div>
