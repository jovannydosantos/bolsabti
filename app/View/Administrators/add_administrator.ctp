...
?>
	...
	<blockquote style="border-top-width: 0px; padding-top: 0px; padding-bottom: 0px;margin-top: 15px;">
        <p style="color: #588BAD">Cada administrador verá sólo a los alumnos que esten en el nivel y entidad a la cual fué asignado.</p>
    </blockquote>
    ...
    <div class="col-md-12" >
		...
		<div class="col-md-4 col-md-offset-1 fondoBti" style="padding-top: 10px">
			...
			<blockquote style="border-top-width: 0px; padding-top: 0px; padding-bottom: 0px;margin-top: 15px;">
		        <p style="color: #fff"> Datos de acceso.</p>
		    </blockquote>
