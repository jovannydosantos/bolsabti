...
?>
	...
	function validate_fechaMayorQue(fechaInicial,fechaFinal){
		...
		function validateTelephoneNotificationForm(){
				...
				if(responseValidateDate == false){
					alert ('La fecha de la entrevista telefónica no es válida');
					document.getElementById('StudentTelephoneNotificationDateDay').focus();
					return false;
				}else{
		...
		function validatePersonalNotificationForm(){
			...
			if(document.getElementById('StudentPersonalNotificationMessage').value == ''){
				alert ('Ingrese el mensaje para la notificación personal');
			...
			if(responseValidateDate == false){
				alert ('La fecha de la entrevista personal no es válida');
				document.getElementById('StudentPersonalNotificationDateDay').focus();
				return false;
			}else{
	...
	<div class="col-md-12">
			...
			<div class="col-md-12" style="padding-left: 0px;">
				...
				<?php 	$options = array('25' => 25, '50' => 50, '100' => 100, '200' => 200);
						echo $this->Form->input('limit', array(
															...
															'before' => '<div class="col-md-12 " style="margin-left: 160px;"',
		...
		<div class="col-md-10" style="max-height: 760px; witdh:720px; overflow-y: auto; padding-left: 0px; padding-right: 0px;">
					...
					?>
						...
						<div class="col-md-4" style="height: 30px; float: right; background: rgb(88, 89, 91) none repeat scroll 0px 0px; padding-left: 15px; padding-right: 0px;">
										...
										if($totalDescargas>=$company['CompanyOfferOption']['max_cv_download']):
											echo $this->Html->image('student/descargado.png',
																		array(
																			...
																			'style' => 'width: 17px; height: 20px; margin-right: 6px; cursor: help; '
																			)
																	);	
										else:
											echo $this->Html->link(
