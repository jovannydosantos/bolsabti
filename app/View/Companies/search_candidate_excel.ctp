<?php
	...
	$objPHPExcel->getProperties()->setCreator("SISBUT UNAM")
								 ...
								 ->setTitle("Resultados de búsuqeda rápida")
								 ->setSubject("Resultados de búsuqeda rápida")
								 ->setDescription("Resultados de búsuqeda rápida")
								 ->setKeywords("Busqueda rápida")
								 ->setCategory("Busqueda rápida");
	...
	$objPHPExcel->getActiveSheet()->setTitle('Busqueda rápida');
	$objPHPExcel->setActiveSheetIndex(0);
	
	header('Content-Type: application/vnd.openxmlformats-officedocument.spreadsheetml.sheet');
	header('Content-Disposition: attachment;filename="Búsqueda rápida '.$tituloFolder.'.xlsx"');
