<?php
	...
	$objPHPExcel->getProperties()->setCreator("Sistema de Bolsa Universitaria de Trabajo UNAM")
								 ...
								 ->setTitle("Busqueda dentro de la oferta")
								 ->setSubject("Busqueda dentro de la oferta")
								 ->setDescription("Busqueda dentro de la oferta")
								 ->setKeywords("Busqueda dentro de la oferta")
								 ->setCategory("Busqueda dentro de la oferta");
	...
	if(!isset($tipoDescarga)):
		$tipoDescarga = 'Todos los candidatos';
	endif;
		$objPHPExcel->setActiveSheetIndex(0)->setCellValue('A2','Descarga de currículums /  '.$tipoDescarga);
	...
	$objPHPExcel->getActiveSheet()->setTitle('Busqueda dentro de la oferta');
	$objPHPExcel->setActiveSheetIndex(0);
	
	header('Content-Type: application/vnd.openxmlformats-officedocument.spreadsheetml.sheet');
	header('Content-Disposition: attachment;filename="Búsqueda dentro de la oferta .xlsx"');
