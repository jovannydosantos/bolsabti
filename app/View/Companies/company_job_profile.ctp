	...
	<fieldset>
		<div class="col-md-6">
			<div class="col-md-12">
				...
				<?= $this->Form->input('CompanyJobProfile.experience_area', ['type'=>'select','options' => $tiemposExperiencia,'class' => 'selectpicker show-tick form-control show-menu-arrow','default'=>'0', 'empty' => 'Experiencia']); ?>
			</div>		
		</div>
		<div class="col-md-6">
			<div class="col-md-12">
				<?= $this->Form->input('CompanyJobProfile.activity',
				['placeholder' => 'Actividades a desarrollar...','style' => ' max-height: 280px; margin-top: 0px;',
				'maxlength' => '1000']); ?>
