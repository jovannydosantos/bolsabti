<?php
	...
	$objPHPExcel->getProperties()->setCreator("Sistema de Bolsa Universitaria de Trabajo UNAM")
								 ...
								 ->setTitle("Candidatos más vistos")
								 ->setSubject("Candidatos más vistos")
								 ->setDescription("Candidatos más vistos por las empresas")
								 ->setKeywords("Candidatos más vistos")
								 ->setCategory("Candidatos más vistos");
	...
	//Se combinan las celdas
		...
		$objPHPExcel->setActiveSheetIndex(0)->setCellValue('A2','Descarga de currículums / Candidatos más vistos');
	...
	if(isset($dato['StudentHeader']['header'])):
	...
	if(isset($dato['StudentProfile']['disability_type'])):
	...
	if(isset($dato['StudentProfile']['date_of_birth'])):
		if($dato['StudentProfile']['date_of_birth'] <> '0000-00-00'):
			...
			$objPHPExcel->setActiveSheetIndex(0)->setCellValue('H'.$i, 'Sin especificar');
		endif;
	endif;
		...
		if($years <> ''):
			...
			$objPHPExcel->setActiveSheetIndex(0)->setCellValue('I'.$i, 'Sin especificar');
		endif;

	if(isset($dato['StudentProfile']['born_country'])):
	...
	if(isset($dato['StudentProfile']['marital_status'])):
	...
	header('Content-Disposition: attachment;filename="Candidatos más vistos.xlsx"');
