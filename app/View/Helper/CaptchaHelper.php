    ...
    function render($settings=array()) {
        ...
        switch( $this->settings['type']):
            case 'image':
                ...
                echo $this->Form->input( $this->settings['model'].'.'. $this->settings['field'], array('autocomplete'=>'off','label'=> $this->settings['clabel'],'class'=>'clabel form-control','required'=>'required','placeholder'=>'Valor de la imagen'));
            break;
            case 'math':
                ...
                echo $this->Form->input( $this->settings['model'].'.'. $this->settings['field'],array('autocomplete'=>'off','label'=>false,'class'=>'form-control','required'=>'required','placeholder'=>'Resultado de la operación'));
            break;
        endswitch;
    }
}