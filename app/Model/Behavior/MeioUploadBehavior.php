...
class MeioUploadBehavior extends ModelBehavior {
	...
	var $defaultOptions = array(
		...
		'maxSize' => 838860, // 2097152 -> 2MB ahora 838860 -> 80 KB
 ...
 */
	function __construct() {
		$messages = array(
			...
			// ),
			// 'Empty' => array(
				// 'message' => __d('meio_upload', 'El archivo no puede estar vacio.')
			// ),
			// 'UploadError' => array(
				// 'message' => __d('meio_upload', 'Lo sentimos hubo un problema al subir el archivo.')
			// ),
			// 'MaxSize' => array(
				// 'message' => __d('meio_upload', 'El tamaño del archivo excede el límite de 80Kb.')
			// ),
			// 'InvalidMime' => array(
			...
			// ),
			// 'MinWidth' => array(
				// 'message' => __d('meio_upload', 'El ancho de la imagen es más pequeño al permitido 100px.')
			// ),
			// 'MinHeight' => array(
				// 'message' => __d('meio_upload', 'El alto de la imagen es más pequeño al permitido 100px.')
			// ),
			// 'MaxWidth' => array(
				// 'message' => __d('meio_upload', 'El ancho de la imagen excede el límite permitido 200px.')
			// ),
			// 'MaxHeight' => array(
				// 'message' => __d('meio_upload', 'El alto de la imagen excede el límite permitido 200px.')
			// ),
			// 'HttpPost' => array(
